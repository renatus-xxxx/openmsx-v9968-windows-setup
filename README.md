...
Unofficial Windows setup helpers for the V9968-enabled openMSX fork. Version **0.7.3**. This is an independent helper project, not the official openMSX or V9968 project.
...
1. Download `openmsx-v9968-windows-setup-0.7.3.zip` from **Assets** on [GitHub Releases](https://github.com/renatus-xxxx/openmsx-v9968-windows-setup/releases). Extract the **whole ZIP** into a new writable folder outside OneDrive or any other synced folder, for example `C:\MSX`. Do not run BAT files inside a ZIP viewer.
